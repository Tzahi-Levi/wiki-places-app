...
class ThemeController {
      ...
      ThemeData(
          textTheme: TextTheme(
            ...
            headline3: GoogleFonts.openSans(fontSize: 15,
                ...
                color: const Color(0xff393F36)),
            headline4: GoogleFonts.openSans(fontSize: 12,
                fontWeight: FontWeight.normal,
                color: const Color(0xff393F36)),
              headline5: GoogleFonts.openSans(fontSize: 15,
                  fontWeight: FontWeight.normal,
                  color: const Color(0xff8CD29A)),
              headline6: GoogleFonts.openSans(fontSize: 15,
                  fontWeight: FontWeight.normal,
                  color: const Color(0xff393F36)),
          ...
          cardTheme: const CardTheme(
            color: Color(0xff95A68D),
            shadowColor: Colors.black,
          ),
          iconTheme: const IconThemeData(
              color: Color(0xff393F36),
              size: 30
          ),
          floatingActionButtonTheme: const FloatingActionButtonThemeData(
            backgroundColor: Color(0xff8CD29A),
          ),
      );
  ...
  static ThemeData get darkMode => ThemeData(
      ...
      floatingActionButtonTheme: const FloatingActionButtonThemeData(
        backgroundColor: Color(0xff262A24),
      )
  );
}
