...
class ThemeController {
  ...
  static ThemeData get lightMode =>
      ThemeData(
          textTheme: TextTheme(
            ...
            headline5: GoogleFonts.openSans(fontSize: 15, fontWeight: FontWeight.normal, color: const Color(0xff8CD29A)),
  ...
  static ThemeData get darkMode => ThemeData(
      textTheme: TextTheme(
        ...
        headline5: GoogleFonts.openSans(fontSize: 15, fontWeight: FontWeight.normal, color: Colors.white),
