...
class ThemeController {
  ...
  static ThemeData get lightMode => ThemeData.light().copyWith(
      ...
      indicatorColor: _primaryColorLight_light,
      appBarTheme: AppBarTheme(backgroundColor: Colors.transparent, iconTheme: IconThemeData(color: Colors.white, size: 27), systemOverlayStyle: SystemUiOverlayStyle(statusBarColor: Colors.lightGreen.withOpacity(0.2))),
  ...
  static ThemeData get darkMode => ThemeData.dark().copyWith(
      ...
      appBarTheme: AppBarTheme(backgroundColor: Colors.transparent, iconTheme: IconThemeData(color: Colors.white, size: 27), systemOverlayStyle: SystemUiOverlayStyle(statusBarColor: Colors.blueGrey.withOpacity(0.2))),
